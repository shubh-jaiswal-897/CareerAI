...
async def generate_with_gemini(prompt: str, api_key: str | None = None, model: str = DEFAULT_MODEL) -> str:
...
async def generate_career_advice(user_message: str, context: dict = None, api_key: str | None = None):
    prompt = f"""
...
async def analyze_resume_text(resume_text: str, api_key: str | None = None):
    prompt = f"""
